            ...
            <?php if (!$Supplier || !$Customer) { ?>
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="<?= site_url('sales/package_invoice/' . $inv->id) ?>" target="_blank"
                               class="tip btn btn-primary" title="<?= lang('package_invoice') ?>">
                                <i class="fa fa-print"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('package_invoice') ?></span>
                            </a>
                        </div>
