		...
		if(items_package){
			...
			$.each(items_package, function () {
				...
				if(this.id == package_id){
                    gift_card_div.append($('<input type="radio" name="item_package" id="hidden_gift_card" value="' + this.id + '" checked><span style="padding-left:5px !important;">' + this.package_name + ' ( ' + this.card_no + ') (' + i + ')</span><br/>'));
				}else{

                    gift_card_div.append($('<input type="radio" name="item_package" id="hidden_gift_card" value="' + this.id + '"><span style="padding-left:5px !important;">' + this.package_name + ' ( ' + this.card_no + ') (' + i + ')</span><br/>'));
				}
                i++;
			});
