...
class Products_model extends CI_Model
{
	...
	public function get_enter_using_stock_item_by_ref($ref)
	{
        $this->db->select('
		    ...
		    enter_using_stock_items.unit as unit_name,
		    products.cost,
